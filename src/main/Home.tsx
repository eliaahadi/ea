  ...
  return (
    <div className={classes.section}>
      <Grid container spacing={3}>
        ...
        <Grid item xs={6}>
          <Paper className={classes.paper}>Research/Study</Paper>
        </Grid>        
        <Grid item xs={6}>
          <Paper className={classes.paper}>Strategy/Design</Paper>
        </Grid>        
        <Grid item xs={6}>
          <Paper className={classes.paper}>Build/Grow</Paper>
        </Grid>        
        <Grid item xs={6}>
          <Paper className={classes.paper}>Test/Refactor</Paper>
        </Grid>        
      </Grid>
    </div>
  )
    ...
    <div className={classes.section}>
      <Grid container spacing={3}>
        <Grid item xs={12}>
          ...
          <h4 className={classes.paper}>Will be updated...</h4>
        </Grid>
      </Grid>
    </div>
  )
